...
AwsStorageOverride = os.environ.get('AWS_STORAGE_OVERRIDE')
...
SQLALCHEMY_DATABASE_URI = f"mysql+pymysql://{myDBid}:{myDBpw}@woori-fisa2.cfnz7hfzq9bn.ap-northeast-2.rds.amazonaws.com/dotorimuk1112"
